...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9uaXJhZ2EiLCJhIjoiY2tjcm1pb2RjMGE4ODJ3cDQ0MWdpcHljayJ9.4d_zLSzEVjitkGMv6x1SPw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/toniraga/ckcrmv6uk10ad1jphmn6t448z',
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p> Day ".concat(loc.day, ": ").concat(loc.description, " </p>")).addTo(map); // Extends the mark bounds to include current location
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error Logging out, U mati Try Again');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8080/api/v1/users/updateMyPassword' : 'http://localhost:8080/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status || res.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Was Successfully Updated!"));
            }
...
var stripe = Stripe('pk_test_51H7hYRDCovAArinj1FTPJt5YiKw06xwRvAqXAQHcoQzLsdUSY6m1WldHOtaoBiCDFNyXbrusiLDnLFHWX6TSUV9q00rBDxKaor');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:8080/api/v1/booking/checkout-session/".concat(tourId));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4077" + '/');
